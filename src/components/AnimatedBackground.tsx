...
export const AnimatedBackground: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden bg-[#030712]">
      ...
      <div className="absolute -top-40 -left-40 w-96 h-96 bg-cyan-600/20 rounded-full blur-[120px] animate-pulse"></div>
      <div className="absolute top-1/3 -right-40 w-96 h-96 bg-emerald-500/15 rounded-full blur-[140px] animate-pulse delay-1000"></div>
      <div className="absolute bottom-10 left-1/4 w-[30rem] h-[30rem] bg-blue-600/15 rounded-full blur-[150px] animate-pulse delay-2000"></div>
